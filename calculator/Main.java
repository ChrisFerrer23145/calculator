...
public class Main {
	public static void main(String[] args) {
		...
		for (i=0;i<i+1;i++) {
			...
			if (i==0) {
        			System.out.println("Enter equation. For addition, use a + between each number. For subtraction, use a -. For multiplication use *, and for division use /. Square roots use percents, so '%25' prints 5. Exponents use ^, so '5^3' prints 125. For example, to do addition, you would use '691+234', which would print 925. You can even combine equations, and the program will sort it out in order of operations! For example, '25*5/5+10*2' will print 45.0!");
			} else {
